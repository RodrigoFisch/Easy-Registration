...
public enum RegisterPersonErrorEnum {
    ...
    REGISTRATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "Não foi possível realizar o registro."),
    CPF_ALREADY_REGISTERED(HttpStatus.BAD_REQUEST, "CPF já registro."),
    EMAIL_ALREADY_REGISTERED(HttpStatus.BAD_REQUEST, "E-mail já cadastrado" ),
